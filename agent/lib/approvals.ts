...
// can render input.requested prompts; auto-approve is still useful when you want
// uninterrupted tool execution. Toggle with `/approvals auto` in the face
// (writes .env.local + restarts the brain) or set CLANKY_AUTO_APPROVE=1 in
// .env.local directly.
