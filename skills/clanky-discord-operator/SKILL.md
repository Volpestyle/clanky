...
description: Use Clanky's agent-owned Discord tools to inspect guilds/channels, read recent channel activity, send channel messages, upload attachments, and add reactions.
when_to_use: Use when the user asks what Discord servers or channels Clanky can see, asks Clanky to send or read a Discord message, wants a recent Discord digest, provides Discord IDs, or wants a reaction added.
allowed_tools:
  - discord_list_guilds
